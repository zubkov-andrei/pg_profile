\echo Use "ALTER EXTENSION pg_profile UPDATE" to load this file. \quit
 ...
 ALTER INDEX snapshots_pkey RENAME TO snapshots_pkey_old;
 ALTER INDEX ix_snap_time RENAME TO ix_snap_time_old;
 ALTER INDEX pk_snap_params RENAME TO pk_snap_params_old;
 ALTER INDEX baselines_pkey RENAME TO baselines_pkey_old;
 ALTER INDEX baselines_bl_name_key RENAME TO baselines_bl_name_key_old;
 ALTER INDEX bl_snaps_pk RENAME TO bl_snaps_pk_old;
 ALTER INDEX ix_bl_snaps_blid RENAME TO ix_bl_snaps_blid_old;
 ALTER INDEX pk_snap_users RENAME TO pk_snap_users_old;
 ALTER INDEX pk_snap_statements_n RENAME TO pk_snap_statements_n_old;
 ALTER INDEX ix_snap_stmts_qid RENAME TO ix_snap_stmts_qid_old;
 ALTER INDEX pk_snap_statements_total RENAME TO pk_snap_statements_total_old;
 ALTER INDEX pk_tables_list RENAME TO pk_tables_list_old;
 ALTER INDEX pk_snap_stat_user_tables RENAME TO pk_snap_stat_user_tables_old;
 ALTER INDEX pk_indexes_list RENAME TO pk_indexes_list_old;
 ALTER INDEX pk_snap_stat_user_indexes RENAME TO pk_snap_stat_user_indexes_old;
 ALTER INDEX pk_funcs_list RENAME TO pk_funcs_list_old;
 ALTER INDEX pk_snap_stat_user_functions RENAME TO pk_snap_stat_user_functions_old;
 ALTER INDEX pk_snap_statio_user_tables RENAME TO pk_snap_statio_user_tables_old;
 ALTER INDEX pk_snap_statio_user_indexes RENAME TO pk_snap_statio_user_indexes_old;
 ALTER INDEX pk_snap_stat_database RENAME TO pk_snap_stat_database_old;
 ALTER INDEX pk_snap_stat_cluster RENAME TO pk_snap_stat_cluster_old;


 ALTER TABLE snap_params RENAME CONSTRAINT snap_params_snap_id_fkey TO snap_params_snap_id_fkey_old;
 ALTER TABLE bl_snaps RENAME CONSTRAINT bl_snaps_bl_id_fkey TO bl_snaps_bl_id_fkey_old;
 ALTER TABLE bl_snaps RENAME CONSTRAINT bl_snaps_snap_id_fkey TO bl_snaps_snap_id_fkey_old;
 ALTER TABLE snap_statements RENAME CONSTRAINT snap_statements_queryid_md5_fkey TO snap_statements_queryid_md5_fkey_old;
 ALTER TABLE snap_statements RENAME CONSTRAINT snap_statements_snap_id_fkey TO snap_statements_snap_id_fkey_old;
 ALTER TABLE snap_statements_total RENAME CONSTRAINT snap_statements_total_snap_id_fkey TO snap_statements_total_snap_id_fkey_old;
 ALTER TABLE snap_stat_user_tables RENAME CONSTRAINT snap_stat_user_tables_relid_fkey TO snap_stat_user_tables_relid_fkey_old;
 ALTER TABLE snap_stat_user_tables RENAME CONSTRAINT snap_stat_user_tables_snap_id_fkey TO snap_stat_user_tables_snap_id_fkey_old;
 ALTER TABLE snap_stat_user_indexes RENAME CONSTRAINT snap_stat_user_indexes_indexrelid_fkey TO snap_stat_user_indexes_indexrelid_fkey_old;
 ALTER TABLE snap_stat_user_indexes RENAME CONSTRAINT snap_stat_user_indexes_relid_fkey TO snap_stat_user_indexes_relid_fkey_old;
 ALTER TABLE snap_stat_user_indexes RENAME CONSTRAINT snap_stat_user_indexes_snap_id_fkey TO snap_stat_user_indexes_snap_id_fkey_old;
 ALTER TABLE snap_stat_user_functions RENAME CONSTRAINT snap_stat_user_functions_funcid_fkey TO snap_stat_user_functions_funcid_fkey_old;
 ALTER TABLE snap_stat_user_functions RENAME CONSTRAINT snap_stat_user_functions_snap_id_fkey TO snap_stat_user_functions_snap_id_fkey_old;
 ALTER TABLE snap_statio_user_tables RENAME CONSTRAINT snap_statio_user_tables_relid_fkey TO snap_statio_user_tables_relid_fkey_old;
 ALTER TABLE snap_statio_user_tables RENAME CONSTRAINT snap_statio_user_tables_snap_id_fkey TO snap_statio_user_tables_snap_id_fkey_old;
 ALTER TABLE snap_statio_user_indexes RENAME CONSTRAINT snap_statio_user_indexes_indexrelid_fkey TO snap_statio_user_indexes_indexrelid_fkey_old;
 ALTER TABLE snap_statio_user_indexes RENAME CONSTRAINT snap_statio_user_indexes_relid_fkey TO snap_statio_user_indexes_relid_fkey_old;
 ALTER TABLE snap_statio_user_indexes RENAME CONSTRAINT snap_statio_user_indexes_snap_id_fkey TO snap_statio_user_indexes_snap_id_fkey_old;
 ALTER TABLE snap_stat_database RENAME CONSTRAINT snap_stat_database_snap_id_fkey TO snap_stat_database_snap_id_fkey_old;
 ALTER TABLE snap_stat_cluster RENAME CONSTRAINT snap_stat_cluster_snap_id_fkey TO snap_stat_cluster_snap_id_fkey_old;

 DROP VIEW v_snap_statements;
 DROP VIEW v_snap_stat_user_tables;
 DROP VIEW v_snap_stat_user_indexes;
 DROP VIEW v_snap_stat_user_functions;
 DROP VIEW v_snap_statio_user_tables;
 DROP VIEW v_snap_statio_user_indexes;
...
INSERT INTO snapshots SELECT 1,* FROM snapshots_old;

ALTER TABLE snap_params RENAME TO snap_params_old;
...
INSERT INTO snap_params SELECT 1,* FROM snap_params_old;
...
INSERT INTO baselines SELECT 1,* FROM baselines_old;

ALTER TABLE bl_snaps RENAME TO bl_snaps_old;
...
INSERT INTO bl_snaps SELECT 1,* FROM bl_snaps_old;

ALTER TABLE snap_statements RENAME TO snap_statements_old;
...
INSERT INTO snap_statements SELECT 1,* from snap_statements_old;

CREATE OR REPLACE VIEW v_snap_statements AS
SELECT
...
ALTER TABLE snap_statements_total RENAME TO snap_statements_total_old;
...
INSERT INTO snap_statements_total SELECT 1,* FROM snap_statements_total_old;

ALTER TABLE tables_list RENAME TO tables_list_old;
...
INSERT INTO tables_list SELECT 1,* FROM tables_list_old;

ALTER TABLE snap_stat_user_tables RENAME TO snap_stat_user_tables_old;
...
INSERT INTO snap_stat_user_tables SELECT 1,* FROM snap_stat_user_tables_old;

CREATE OR REPLACE VIEW v_snap_stat_user_tables AS
    SELECT
        node_id,
        snap_id,
        dbid,
...
ALTER TABLE last_stat_user_tables RENAME TO last_stat_user_tables_old;
...
INSERT INTO last_stat_user_tables SELECT 1,* FROM last_stat_user_tables_old;

ALTER TABLE indexes_list RENAME TO indexes_list_old;
...
INSERT INTO indexes_list SELECT 1,* FROM indexes_list_old;

ALTER TABLE snap_stat_user_indexes RENAME TO snap_stat_user_indexes_old;
...
INSERT INTO snap_stat_user_indexes SELECT 1,* FROM snap_stat_user_indexes_old;

CREATE OR REPLACE VIEW v_snap_stat_user_indexes AS
    SELECT
        s.node_id,
        s.snap_id,
        s.dbid,
...
ALTER TABLE last_stat_user_indexes RENAME TO last_stat_user_indexes_old;
...
INSERT INTO last_stat_user_indexes SELECT 1, * FROM last_stat_user_indexes_old;

ALTER TABLE funcs_list RENAME TO funcs_list_old;
...
INSERT INTO funcs_list SELECT 1,* FROM funcs_list_old;

ALTER TABLE snap_stat_user_functions RENAME TO snap_stat_user_functions_old;
...
INSERT INTO snap_stat_user_functions SELECT 1,* FROM snap_stat_user_functions_old;

CREATE OR REPLACE VIEW v_snap_stat_user_functions AS
    SELECT
        node_id,
        snap_id,
        dbid,
...
ALTER TABLE last_stat_user_functions RENAME TO last_stat_user_functions_old;
...
INSERT INTO last_stat_user_functions SELECT 1,* FROM last_stat_user_functions_old;

ALTER TABLE snap_statio_user_tables RENAME TO snap_statio_user_tables_old;
...
INSERT INTO snap_statio_user_tables SELECT 1,* FROM snap_statio_user_tables_old;

CREATE OR REPLACE VIEW v_snap_statio_user_tables AS
    SELECT
        node_id,
        snap_id,
        dbid,
...
ALTER TABLE last_statio_user_tables RENAME TO last_statio_user_tables_old;
...
INSERT INTO last_statio_user_tables SELECT 1,* FROM last_statio_user_tables_old;

ALTER TABLE snap_statio_user_indexes RENAME TO snap_statio_user_indexes_old;
...
INSERT INTO snap_statio_user_indexes SELECT 1,* FROM snap_statio_user_indexes_old;

CREATE OR REPLACE VIEW v_snap_statio_user_indexes AS
    SELECT
        s.node_id,
        s.snap_id,
        s.dbid,
...
ALTER TABLE last_statio_user_indexes RENAME TO last_statio_user_indexes_old;
...
INSERT INTO last_statio_user_indexes SELECT 1,* FROM last_statio_user_indexes_old;

ALTER TABLE snap_stat_database RENAME TO snap_stat_database_old;
...
INSERT INTO snap_stat_database SELECT 1,* FROM snap_stat_database_old;

ALTER TABLE last_stat_database RENAME TO last_stat_database_old;
...
INSERT INTO last_stat_database SELECT 1,* FROM last_stat_database_old;

ALTER TABLE snap_stat_cluster RENAME TO snap_stat_cluster_old;
...
INSERT INTO snap_stat_cluster SELECT 1,* FROM snap_stat_cluster_old;

ALTER TABLE last_stat_cluster RENAME TO last_stat_cluster_old;
...
INSERT INTO last_stat_cluster SELECT 1,* FROM last_stat_cluster_old;
...
DROP TABLE baselines_old,
 ...
 bl_snaps_old,
 snap_statements_old,
 snap_statements_total_old,
 snap_stat_user_tables_old,
 last_stat_user_tables_old,
 snap_stat_user_indexes_old,
 last_stat_user_indexes_old,
 tables_list_old,
 indexes_list_old,
 funcs_list_old,
 snap_stat_user_functions_old,
 last_stat_user_functions_old,
 snap_statio_user_tables_old,
 last_statio_user_tables_old,
 snap_statio_user_indexes_old,
 last_statio_user_indexes_old,
 snap_stat_database_old,
 last_stat_database_old,
 snap_stat_cluster_old,
