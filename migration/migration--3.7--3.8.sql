UPDATE import_queries_version_order
  SET version = '3.8'
WHERE (extension, version) = ('pg_profile','3.7');

/* Constraint change */
ALTER TABLE last_stat_indexes DROP CONSTRAINT pk_last_stat_indexes;
ALTER TABLE last_stat_indexes ALTER COLUMN relid SET NOT NULL;
ALTER TABLE last_stat_indexes ADD CONSTRAINT pk_last_stat_indexes
