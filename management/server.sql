...
RETURNS TABLE(server_name name, server_hostname text, server_ip text, server_port integer, connstr text, enabled boolean, max_sample_age integer, description text)
SET search_path=@extschema@ AS $$
DECLARE
  c_priv CURSOR FOR
