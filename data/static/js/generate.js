...
class BaseTable extends BaseSection {
    ...
    static properties = {
        ...
        'server_hostname': data.properties.server_hostname,
        'server_ip': data.properties.server_ip,
        'server_port': data.properties.server_port,
        'cpu_cores': data.properties.cpu_cores,
        'cpu_model': data.properties.cpu_model,
        'cpu_mhz': data.properties.cpu_mhz,
        'cpu_sockets': data.properties.cpu_sockets,
        'memory_total_mb': data.properties.memory_total_mb,
        'load_avg_1min': data.properties.load_avg_1min,
        'load_avg_5min': data.properties.load_avg_5min,
        'load_avg_15min': data.properties.load_avg_15min,
        'cpu_user_pct': data.properties.cpu_user_pct,
        'cpu_system_pct': data.properties.cpu_system_pct,
        'cpu_idle_pct': data.properties.cpu_idle_pct,
