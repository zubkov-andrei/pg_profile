...
(1, 'stmt_warn', NULL, 800, NULL, 'Warning!', 'stmt_cnt_all', NULL, NULL, NULL,
  '[{'
    '"type": "row_table", '
    '"source": "stmt_cnt_all",'
    '"ordering": "sample_id",'
...
INSERT INTO report_struct (
  ...
  content, sect_struct)
VALUES
(1, 'dbstat1', 'srvstat', 100, 'Database statistics', 'Database statistics', NULL, NULL, 'db_stat', NULL, NULL),
(1, 'dbstat2', 'srvstat', 200, NULL, NULL, 'dbstats_reset', NULL, NULL,
  ...
  '[{'
      ...
      '"columns": ['
          ...
          '{"title": "Filesystem reads", "caption": "Read Bytes", "columns": ['
              ...
              '{"id": "exec_reads", "class": "table_obj_value", "title": "Filesystem read amount during execution", "caption": "Exec"},'
          ...
          '{"title": "Filesystem writes", "caption": "Write Bytes", "columns": ['
              ...
              '{"id": "exec_writes", "class": "table_obj_value", "title": "Filesystem write amount during execution", "caption": "Exec"},'
...
(1, 'tbldml', 'objects', 400, 'Top DML tables', 'Top DML tables', NULL, NULL, 'dml_tbl', NULL,
  '[{'
    ...
    ']'
  '}]'::jsonb),
(1, 'tblud', 'objects', 500, 'Top tables by updated/deleted tuples', 'Top tables by updated/deleted tuples', NULL, NULL, 'vac_tbl', NULL,
  '[{'
    '"type": "row_table",'
    '"class": "toast",'
    '"source": "top_tables",'
...
(2, 'stmt_warn', NULL, 900, NULL, 'Warning!', 'stmt_cnt_all', NULL, NULL, NULL,
  '[{'
    '"type": "row_table", '
    '"source": "stmt_cnt_all",'
    '"ordering": "sample_id",'
...
(2, 'dbstatreset', 'dbstat', 200, NULL, NULL, 'dbstats_reset', NULL, NULL,
  ...
  '[{'
        ...
        '"columns": ['
            ...
            '{"id": "datname", "class": "table_obj_name", "caption": "Database"}, '
            '{"id": "sample_id", "class": "table_obj_value", "caption": "Sample"}, '
...
(2, 'sqlfetch', 'sqlsthdr', 600, 'Top SQL by shared blocks fetched', 'Top SQL by shared blocks fetched', NULL, NULL, 'top_pgs_fetched', NULL,
  '[{'
      ...
      '"source": "top_statements",'
      '"ordering": "ord_shared_blocks_fetched",'
      '"filter": "ord_shared_blocks_fetched",'
      '"limit": "topn",'
      '"columns": ['
          '{"id": "hexqueryid", "class": "hdr mono queryId", "caption": "Query ID", "rowspan": true}, '
          '{"id": "dbname", "class": "hdr", "caption": "Database", "rowspan": true}, '
...
(2, 'sqlshwr', 'sqlsthdr', 900, 'Top SQL by shared blocks written', 'Top SQL by shared blocks written', NULL, NULL, 'top_shared_written', NULL,
  '[{'
      ...
      '"class": "diff", '
      '"source": "top_statements",'
      '"filter": "ord_shared_blocks_written",'
      '"ordering": "ord_shared_blocks_written",'
      '"limit": "topn",'
      '"columns": ['
          '{"id": "hexqueryid", "class": "hdr mono queryId", "caption": "Query ID", "rowspan": true}, '
  ...
  '[{'
      ...
      '"columns": ['
          ...
          '{"title": "Filesystem reads", "caption": "Read Bytes", "columns": ['
              ...
              '{"id": ["exec_reads1", "exec_reads2"], "class": "table_obj_value", "title": "Filesystem read amount during execution", "caption": "Exec"},'
          ...
          '{"title": "Filesystem writes", "caption": "Write Bytes", "columns": ['
             ...
             '{"id": ["exec_writes1", "exec_writes2"], "class": "table_obj_value", "title": "Filesystem write amount during execution", "caption": "Exec"},'
...
(2, 'tbldml', 'objects', 400, 'Top DML tables', 'Top DML tables', NULL, NULL, 'dml_tbl', NULL,
  '[{'
    ...
    ']'
  '}]'::jsonb),
(2, 'tblud', 'objects', 500, 'Top tables by updated/deleted tuples', 'Top tables by updated/deleted tuples', NULL, NULL, 'vac_tbl', NULL,
  '[{'
    '"type": "row_table",'
    '"class": "diff",'
    '"source": "top_tables",'
