...
(1, 'rep_details', NULL, 10, 'Report details', 'Report details', NULL, NULL, NULL,
  '[{'
    ...
    '"columns": ['
        ...
        '{"caption": "Network Information", "class": "table_obj_value", "columns": ['
...
'[{'
    ...
    '"columns": ['
      ...
      '{"caption": "Transactions", "columns": ['
        ...
        '{"caption": "Total", "id": "total_xacts", "class": "table_obj_value", '
          '"title": "Total number of transactions (commits + rollbacks)"},'
        '{"caption": "Commits/s", "id": "commits_per_sec", "class": "table_obj_value", '
          '"title": "Commits per second"},'
        '{"caption": "Rollbacks/s", "id": "rollbacks_per_sec", "class": "table_obj_value", '
          '"title": "Rollbacks per second"},'
        '{"caption": "Xacts/s", "id": "xacts_per_sec", "class": "table_obj_value", '
...
(1, 'sqllist', 'sqlsthdr', 1300, 'Complete list of SQL texts', 'Complete list of SQL texts', NULL, NULL, NULL,
  '[{'
    ...
    '"columns": ['
      ...
      '{"id": "query_texts", "class": "mono queryText", "caption": "Query Text"}'
    ']'
  '}]'::jsonb)
;
...
(2, 'rep_details', NULL, 10, 'Report details', 'Report details', NULL, NULL, NULL,
  '[{'
    ...
    '"columns": ['
        ...
        '{"caption": "Network Information", "class": "hdr table_obj_value", "rowspan": true, "columns": ['
          '{"id": "server_hostname", "class": "hdr table_obj_value", "caption": "Hostname", "rowspan": true},'
          '{"id": "server_ip", "class": "hdr table_obj_value", "caption": "IP Address", "rowspan": true},'
          '{"id": "server_port", "class": "hdr table_obj_value", "caption": "Port", "rowspan": true}'
        ']},'
...
'[{'
    ...
    '"columns": ['
        ...
        '{"caption": "Transactions", "columns": ['
            ...
            '{"id": ["total_xacts1", "total_xacts2"], "class": "table_obj_value", "title": "Total number of transactions (commits + rollbacks)", "caption": "Total"}, '
            '{"id": ["commits_per_sec1", "commits_per_sec2"], "class": "table_obj_value", "title": "Commits per second", "caption": "Commits/s"}, '
            '{"id": ["rollbacks_per_sec1", "rollbacks_per_sec2"], "class": "table_obj_value", "title": "Rollbacks per second", "caption": "Rollbacks/s"}, '
            '{"id": ["xacts_per_sec1", "xacts_per_sec2"], "class": "table_obj_value", "title": "Transactions per second", "caption": "Xacts/s"}, '
...
'[{'
    ...
    '],'
    '"columns": ['
      '{"caption": "Database", "id": "dbname", "class": "hdr", "rowspan": "true"},'
      '{"id": ["1", "2"], "title":["properties.timePeriod1", "properties.timePeriod2"], "class": "interval", "caption": "I"}, '
      '{"caption": "Summary", "columns": ['
