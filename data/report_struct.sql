...
(1, 'vacops', 'vachdr', 100, 'Top tables by vacuum operations', 'Top tables by vacuum operations', NULL, NULL, NULL,
  '[{'
    ...
    '"columns": ['
     ...
     ']},'
     '{"caption": "Vacuum time (ms)", "title": "Time spent by vacuum operations on a table", "condition": "vacuum_time", "columns": ['
          '{"caption": "Vacuum", "id": "total_vacuum_time", "title": "Total time this table has been manually vacuumed, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"},'
          '{"caption": "AutoVacuum", "id": "total_autovacuum_time", "title": "Total time this table has been vacuumed by the autovacuum daemon, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"}'
     ']},'
...
(1, 'anops', 'vachdr', 150, 'Top tables by analyze operations', 'Top tables by analyze operations', NULL, NULL, NULL,
  '[{'
    ...
    '"columns": ['
     ...
     ']},'
     '{"caption": "Analyze time (ms)", "title": "Time spent by analyze operations on a table", "condition": "analyze_time", "columns": ['
          '{"caption": "Analyze", "id": "total_analyze_time", "title": "Total time this table has been manually analyzed, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"},'
          '{"caption": "AutoAnalyze", "id": "total_autoanalyze_time", "title": "Total time this table has been analyzed by the autovacuum daemon, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Ins", "id": "n_tup_ins", "class": "table_obj_value", "title": "Number of rows inserted"},'
     '{"caption": "Upd", "id": "n_tup_upd", "class": "table_obj_value", "title": "Number of rows updated (includes HOT updated rows)"},'
     '{"caption": "Del", "id": "n_tup_del", "class": "table_obj_value", "title": "Number of rows deleted"},'
...
(1, 'vactime', 'vachdr', 200, 'Top tables by vacuum time spent', 'Top tables by vacuum time spent', 'vacuum_time', NULL, NULL,
  '[{'
    ...
    '"columns": ['
     ...
     '{"caption": "Schema", "id": "schemaname", "class": "table_obj_name"},'
     '{"caption": "Table", "id": "relname", "class": "table_obj_name"},'
     '{"caption": "Vacuum time (ms)", "title": "Time spent by vacuum operations on a table", "columns": ['
          '{"caption": "Vacuum", "id": "total_vacuum_time", "title": "Total time this table has been manually vacuumed, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"},'
          '{"caption": "AutoVacuum", "id": "total_autovacuum_time", "title": "Total time this table has been vacuumed by the autovacuum daemon, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Vacuum count", "title": "Number of times vacuum operation was performed on the underlying table", "columns": ['
...
(1, 'antime', 'vachdr', 250, 'Top tables by analyze time spent', 'Top tables by analyze time spent', 'analyze_time', NULL, NULL,
  '[{'
    ...
    '"columns": ['
     ...
     '{"caption": "Schema", "id": "schemaname", "class": "table_obj_name"},'
     '{"caption": "Table", "id": "relname", "class": "table_obj_name"},'
     '{"caption": "Analyze time (ms)", "title": "Time spent by analyze operations on a table", "columns": ['
          '{"caption": "Analyze", "id": "total_analyze_time", "title": "Total time this table has been manually analyzed, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"},'
          '{"caption": "AutoAnalyze", "id": "total_autoanalyze_time", "title": "Total time this table has been analyzed by the autovacuum daemon, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Analyze count", "title": "Number of times vacuum operation was performed on the underlying table", "columns": ['
...
(2, 'vacops', 'vachdr', 100, 'Top tables by vacuum operations', 'Top tables by vacuum operations', NULL, NULL, NULL,
  '[{'
    ...
    '"columns": ['
     ...
     ']},'
     '{"caption": "Vacuum time (ms)", "title": "Time spent by vacuum operations on a table", "condition": "vacuum_time", "columns": ['
          '{"caption": "Vacuum", "id": ["total_vacuum_time1", "total_vacuum_time2"], "title": "Total time this table has been manually vacuumed, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"},'
          '{"caption": "AutoVacuum", "id": ["atotal_autovacuum_time1", "total_autovacuum_time2"], "title": "Total time this table has been vacuumed by the autovacuum daemon, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"}'
     ']},'
...
(2, 'anops', 'vachdr', 150, 'Top tables by analyze operations', 'Top tables by analyze operations', NULL, NULL, NULL,
  '[{'
    ...
    '"columns": ['
     ...
     ']},'
     '{"caption": "Analyze time (ms)", "title": "Time spent by analyze operations on a table", "condition": "analyze_time", "columns": ['
          '{"caption": "Analyze", "id": ["total_analyze_time1", "total_analyze_time2"], "title": "Total time this table has been manually analyzed, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"},'
          '{"caption": "AutoAnalyze", "id": ["total_autoanalyze_time1", "total_autoanalyze_time2"], "title": "Total time this table has been analyzed by the autovacuum daemon, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Ins", "id": ["n_tup_ins1", "n_tup_ins2"], "class": "table_obj_value", "title": "Number of rows inserted"},'
     '{"caption": "Upd", "id": ["n_tup_upd1", "n_tup_upd2"], "class": "table_obj_value", "title": "Number of rows updated (includes HOT updated rows)"},'
     '{"caption": "Del", "id": ["n_tup_del1", "n_tup_del2"], "class": "table_obj_value", "title": "Number of rows deleted"},'
...
(2, 'vactime', 'vachdr', 200, 'Top tables by vacuum time spent', 'Top tables by vacuum time spent', 'vacuum_time', NULL, NULL,
  '[{'
    ...
    '"columns": ['
     ...
     '{"caption": "Vacuum time (ms)", "title": "Time spent by vacuum operations on a table", "columns": ['
          '{"caption": "Vacuum", "id": ["total_vacuum_time1", "total_vacuum_time2"], "title": "Total time this table has been manually vacuumed, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"},'
          '{"caption": "AutoVacuum", "id": ["total_autovacuum_time1", "total_autovacuum_time2"], "title": "Total time this table has been vacuumed by the autovacuum daemon, in milliseconds. (This includes the time spent sleeping due to cost-based delays.)", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Vacuum count", "title": "Number of times vacuum operation was performed on the underlying table", "columns": ['
          '{"caption": "Vacuum", "id": ["vacuum_count1", "vacuum_count2"], "title": "Number of times this table has been manually vacuumed (not counting VACUUM FULL)", "class": "table_obj_value"},'
          '{"caption": "AutoVacuum", "id": ["autovacuum_count1", "autovacuum_count2"], "title": "Number of times this table has been vacuumed by the autovacuum daemon", "class": "table_obj_value"}'
